...
import { Play, TrendingUp, Clock, Zap, BookOpen, Globe, ChevronRight } from 'lucide-react';
...
const HomeScreen: React.FC<HomeProps> = ({ stats, recentBook, onNavigate, onContinueReading, settings, onUpdateSettings, t }) => {
  ...
  return (
    <div className="min-h-screen pb-24" style={{ backgroundColor: THEME.bgLight }}>
      {/* Hero Section */}
      <div 
        className="relative h-[340px] flex flex-col justify-end pb-10 px-6 text-white overflow-hidden rounded-b-[3rem] shadow-2xl shadow-blue-900/20"
        style={{
