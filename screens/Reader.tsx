    ...
    <div className={`fixed inset-0 ${currentThemeStyles.bg} z-50 flex flex-col font-sans overflow-hidden transition-colors duration-500`}>
      ...
      {showIntro && (
        <div className="fixed inset-0 z-[150] bg-black/60 backdrop-blur-xl flex items-center justify-center p-6">
            <div className="bg-white rounded-[3rem] w-full max-w-lg p-10 shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
                ...
                <h2 className="text-2xl font-black text-gray-800 text-center mb-2">{t('welcome_back')}</h2>
              ...
              {book.content.map((word, idx) => {
                ...
                return (
                    <span 
                      ...
                      className={`inline-block cursor-pointer px-0.5 rounded transition-all duration-300 ${
                          idx === bookmarkIndex 
